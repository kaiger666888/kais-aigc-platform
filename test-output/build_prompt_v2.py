...
# 跳过 RemoveBackground，直接用 front mask=全白（假设已去背景）
workflow = {
    "2": {
    ...
    "3": {
        ...
        "inputs": {
            "image": "multiview_demo/front.jpg"
        }
    },
    "5": {
...
payload = {"prompt": workflow, "client_id": "demo_002"}
with open("/home/kai/workspace/kais-aigc-platform/test-output/prompt_v2.json", "w") as f:
    json.dump(payload, f, indent=2)
print("v2 written (skip RemoveBackground)")
