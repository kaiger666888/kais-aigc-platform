...
process.on("unhandledRejection", (reason, promise) => {
    ...
    if (reason instanceof Error) {
        ...
        console.error("序列化详情:", JSON.stringify((0, serialize_error_1.serializeError)(reason), null, 2));
    }
    else {
...
process.on("uncaughtException", (error) => {
    ...
    console.error("序列化详情:", JSON.stringify((0, serialize_error_1.serializeError)(error), null, 2));
});
