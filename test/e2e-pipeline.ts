/**
 * aigc-platform runtime V8 — 20 步全管线 E2E 测试
 *
 * 验证:
 * - 所有 20 步可执行
 * - 审核门（11 个）正确触发并等待确认
...
function generateMarkdownReport(report: E2EReport): string {
  ...
  let md = `# aigc-platform runtime V8 E2E Pipeline Test Report\n\n`;
  ...
  md += `---\n*Generated by aigc-platform runtime E2E Pipeline Test*\n`;
...
async function main() {
  ...
  console.log("╔═══════════════════════════════════════════════════════════════╗");
  console.log("║   aigc-platform runtime V8 — 20-Step E2E Pipeline Test      ║");
  console.log("╚═══════════════════════════════════════════════════════════════╝");
