...
Last activity: 2026-07-12 — Completed quick task schema-ui-backfill (asset detail panel root-cause fix: import params flatten + sidecar txt + schema strictness + UI fallback + dry-run backfill script)
