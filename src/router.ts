...
import route105 from "./routes/proxy/goldTeam";
import route106 from "./routes/proxy/movieAgent";
import route107 from "./routes/proxy/reviewPlatform";
...
export default async (app: Express) => {
  ...
  app.use("/api/proxy/goldTeam", route105);
  app.use("/api/proxy/movieAgent", route106);
  app.use("/api/proxy/reviewPlatform", route107);
